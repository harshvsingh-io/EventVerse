...
import { Compass, Key, Sparkles, AlertCircle } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-[#06060c] text-white flex flex-col justify-between overflow-hidden font-sans">
      ...
      <header className="relative z-10 w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => router.push("/")}>
          ...
          <div>
            ...
            <p className="text-[10px] text-brand-secondary uppercase tracking-widest font-semibold mt-0.5">Student Universe</p>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md glass-glow-card rounded-2xl p-8 relative overflow-hidden space-y-6">
          <div className="absolute top-0 right-0 w-24 h-24 bg-brand-primary/25 rounded-full blur-2xl pointer-events-none"></div>

          <div className="space-y-2 text-center">
            <h3 className="font-display font-bold text-2xl text-white">Student Registration</h3>
            <p className="text-sm text-gray-400">Connect your account to enter your campus universe</p>
          </div>
          ...
          <div className="space-y-3.5">
            ...
            >
              ...
              <span>Verify with College Microsoft Account</span>
            </button>
          ...
          <div className="text-[10px] text-gray-500 leading-relaxed text-center bg-white/3 p-3 rounded-lg border border-white/5">
            ⚠️ <span className="font-semibold text-gray-400">Important:</span> Only Microsoft OAuth verify domain matching for automatic student onboarding. Google sign-in is processed as non-verified by default.
          </div>
        </div>
      </main>
