...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#06060c] text-white flex flex-col justify-between overflow-hidden font-sans">
      {/* Decorative Orbs */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-brand-primary/10 blur-[120px] animate-float-slow pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-brand-secondary/10 blur-[120px] animate-float-medium pointer-events-none"></div>
      ...
      <header className="relative z-10 w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="text-xs text-gray-400 hover:text-white transition-colors py-1 px-3 rounded-full border border-white/5 bg-white/5 backdrop-blur-sm"
          >
            Quick Guest Demo
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0 pt-6">
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Strict Row Level Security (RLS) guarantees data privacy per college.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 text-left">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full flex items-start gap-4 p-4 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 hover:border-brand-primary/40 text-left transition-all group"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-start gap-4 p-4 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 hover:border-brand-primary/40 text-left transition-all group"
                  >
                    <div className="p-2 rounded-lg bg-brand-secondary/10 text-brand-secondary mt-0.5">
